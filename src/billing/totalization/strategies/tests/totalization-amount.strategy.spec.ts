...
describe('TotalizationAmountStrategy', () => {
  ...
  it('should have the correct type', () => {
    expect(strategy.type).toBe(StrategyType.AMOUNT);
  });
  ...
  it('should accumulate multiple calls with amounts', () => {
    const call1: Call = { destination: '+54911111111', duration: 60, timestamp: '2025-01-01', amount: 10, isFriend: true, isNational: true, isInternational: false };
    const call2: Call = { destination: '+191167980952', duration: 120, timestamp: '2025-01-02', amount: 90, isFriend: false, isNational: false, isInternational: true };
  ...
  it('should reset total to zero', () => {
    const call: Call = { destination: '+54911111111', duration: 60, timestamp: '2025-01-01', amount: 10, isFriend: true, isNational: true, isInternational: false };
    strategy.processCall(call);
    strategy.reset();
    expect(strategy.getResult()).toEqual(['total', 0]);
  });
